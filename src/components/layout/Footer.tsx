      ...
      <div className="container-luxury px-4 md:px-0 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 py-4">
          ...
          <div className="flex flex-wrap gap-3 md:gap-5 items-center justify-center">
            ...
            <a href="tel:+12894010002" className="flex items-center gap-1 px-3 py-1.5 rounded-full border border-primary/20 bg-primary/5 hover:border-primary/40 hover:bg-primary/10 text-xs text-muted-foreground hover:text-primary transition-all">
