      ...
      <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
        <div className="flex-1 flex justify-center items-center mb-6 md:mb-0 md:mr-6">
          <img
            ...
            className="w-full max-w-xs sm:max-w-md md:max-w-[600px] h-48 sm:h-64 md:h-[400px] object-cover rounded-xl gold-border shadow-md border-[0.5px] border-gold/30 bg-white/40"
            loading="lazy"
          />
        </div>
